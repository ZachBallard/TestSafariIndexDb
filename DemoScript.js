    ...
    then(function (images) {
        ...
        if (images.length == 0) {
            ...
            $.each(images, function (i, image) {
                $("#uploadedImageList .panel-body").append('<div class="image-thumbnail col-sm-2" data-id="' + image.ImageId + '"><img src="' + urlCreator.createObjectURL(image.ImageContent) + '" /></div>');
            });
            $("#btnClearImages").show();
        }
    });
